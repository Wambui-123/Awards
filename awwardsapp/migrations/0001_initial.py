# Generated by Django 3.1 on 2022-06-13 08:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prof_ref', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='projects', to='awwardsapp.profile')),
            ],
            options={
                'ordering': ['pub_date'],
            },
